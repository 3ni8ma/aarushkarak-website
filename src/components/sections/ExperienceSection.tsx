...
const experiences = [
  {
    ...
    desc: "Open-source civic data platforms with cloud-native backend systems.",
  },
  {
    role: "Web Developer",
    company: "Chingu",
    period: "Jun 2026 - Present",
    desc: "Agile Voyage cohort. Python, PostgreSQL, React/Node.js pipelines.",
  },
  {
    role: "Application Developer",
    company: "Hack Club",
    period: "Jun 2025 - Present",
    desc: "Full-stack apps with serverless reactive architecture.",
  },
  {
    role: "Web Developer",
    company: "Fiverr",
    period: "Apr 2025 - Present",
    desc: "$5,000+ in freelance — 3D, AI, financial analytics.",
  },
  {
    role: "Co-Founder & CEO",
    company: "The Coder Bros",
    period: "Jul 2023 - Present",
    desc: "Student-led tech initiative. AI, web, spatial computing.",
  },
  {
    role: "Maker Studio Teen Intern",
    company: "Sci-Tech",
    period: "Jun 2025 - Sep 2025",
    desc: "40+ hours in competitive STEM makerspace. Youngest accepted intern.",
  },
];
