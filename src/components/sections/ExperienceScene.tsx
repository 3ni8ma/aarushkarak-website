...
const experiences = [
  { role: 'Back End Developer', company: 'CommunityOne', period: 'Jun 2026 - Present' },
  { role: 'Web Developer', company: 'Chingu', period: 'Jun 2026 - Present' },
  { role: 'Application Developer', company: 'Hack Club', period: 'Jun 2025 - Present' },
  { role: 'Web Developer', company: 'Fiverr', period: 'Apr 2025 - Present' },
  { role: 'Co-Founder & CEO', company: 'The Coder Bros', period: 'Jul 2023 - Present' },
  { role: 'Maker Studio Teen Intern', company: 'Sci-Tech', period: 'Jun 2025 - Sep 2025' },
]
...
function ExperienceNode({ index, total, color }: { index: number; total: number; color: THREE.Color }) {
