...
export default function HeroSection() {
  ...
  return (
    ...
    >
      <div
        className="absolute top-1/4 -left-32 w-[500px] h-[500px] rounded-full opacity-20 animate-orb pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(var(--color-primary), 0.15) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
        aria-hidden="true"
      />
      <div
        className="absolute bottom-1/4 -right-32 w-[400px] h-[400px] rounded-full opacity-20 animate-orb pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(var(--color-secondary), 0.15) 0%, transparent 70%)",
          filter: "blur(50px)",
          animationDelay: "-3s",
        }}
        aria-hidden="true"
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-10 animate-orb pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(var(--color-accent), 0.1) 0%, transparent 70%)",
          filter: "blur(80px)",
          animationDelay: "-5s",
        }}
        aria-hidden="true"
            ...
            >
              <div className="frosted p-6 sm:p-8 lg:p-10 space-y-5">
                ...
                <p className="text-sm sm:text-base text-pop-secondary max-w-2xl leading-relaxed">
                  Full-stack &amp; spatial computing engineer &mdash; building
                  across AI, 3D, and the modern web.
                </p>
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-1">
                  <Link
                    to="/projects"
                    className="px-7 py-3 rounded-full text-white font-semibold text-sm hover:opacity-80 transition-all shadow-lg"
                    style={{
                      backgroundColor: "rgb(var(--color-primary))",
                      boxShadow: "0 0 24px rgba(var(--color-primary), 0.25)",
                    }}
                  >
                    View my work
                  </Link>
                  <Link
                    to="/contact"
                    className="px-7 py-3 rounded-full text-sm font-semibold text-light hover:bg-white/10 transition-all border border-white/10"
                  >
                    Get in touch
                  </Link>
                </div>
            ...
            >
              ...
              >
                <a
                  ...
                  className="w-11 h-11 rounded-full glass flex items-center justify-center hover:bg-white/10 transition-all duration-300 hover:scale-110"
      ...
      <motion.a
        ...
        transition={{
          ...
          y: { delay: 0.9, duration: 1.5, repeat: Infinity },
        }}
