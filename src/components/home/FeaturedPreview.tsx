...
const featured = [
  { title: 'HELIOS', desc: 'Browser-based AI OS with hand-gesture navigation and 3D spatial interface.', tags: ['Three.js', 'MediaPipe', 'React'], color: 'primary', link: 'https://github.com/3ni8ma/HELIOS' },
  { title: 'Finance Hub', desc: 'Full-stack financial intelligence with live monitoring and AI prediction.', tags: ['Python', 'PostgreSQL', 'React'], color: 'secondary', link: 'https://github.com/3ni8ma/Finance-Hub' },
]
  ...
  return (
    <section className="section-container pt-0">
      ...
      <div className="grid sm:grid-cols-2 gap-6">
          {featured.map((p, i) => (
            <GlassCard key={p.title} delay={i * 0.1} onClick={p.link ? () => window.open(p.link, '_blank', 'noopener,noreferrer') : undefined}>
