      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3 space-y-6">
            <div className="frosted p-6 sm:p-8 space-y-6">
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="text-pop-secondary leading-relaxed text-base sm:text-lg font-normal"
              >
            ...
            {info.map((item, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-pop-accent/70 mb-0.5">{item.label}</p>
