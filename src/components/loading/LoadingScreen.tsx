    ...
    function draw() {
      ...
      particles.forEach((p) => {
        ...
        const alpha = burstRef.current
          ...
          : p.opacity *
            (0.6 + 0.4 * Math.sin((Date.now() / 1000) * p.duration + p.delay));
        ...
        >
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(var(--color-primary), 0.15), transparent 70%)",
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(var(--color-secondary), 0.12), transparent 70%)",
          ...
          <div className="fixed bottom-10 left-0 w-full overflow-hidden pointer-events-none">
            <div className="loading-marquee whitespace-nowrap text-[40px] sm:text-[60px] lg:text-[100px] font-semibold uppercase opacity-[0.04]">
              <span className="inline-block animate-marquee">
                Software Developer &mdash; Spatial Computing &mdash; Full-Stack
                &mdash; AI &mdash;
              </span>
