...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      style={
        scrolled
          ? { background: "var(--nav-bg)", borderColor: "var(--nav-border)" }
          : undefined
      }
      role="navigation"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link
            to="/"
            className="group flex items-center gap-1 text-xl font-sans font-bold tracking-wide"
            aria-label="Home page"
          >
            <span className="text-light">AK</span>
            <span
              className="text-pop-primary transition-all duration-300 group-hover:shadow-[0_0_12px_rgba(var(--color-primary),0.5)]"
          ...
          <div className="hidden md:flex items-center gap-1">
            <div
              ref={navRef}
              className="relative flex items-center gap-1 px-1 py-1 rounded-full"
