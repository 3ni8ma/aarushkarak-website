...
import { Palette, Flame, Leaf, Droplets, Sun, Moon, SunMoon } from 'lucide-react'
...
export default function ThemeToggle() {
  ...
  return (
    <div ref={ref} className="relative flex items-center gap-1">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 rounded-2xl p-2 min-w-[160px] shadow-xl z-[100]" style={{ background: 'var(--glass-bg)', backdropFilter: 'blur(40px)', border: '1px solid var(--glass-border)', boxShadow: 'var(--glass-shadow)' }} role="listbox" aria-label="Select theme">
          {themes.map(t => {
