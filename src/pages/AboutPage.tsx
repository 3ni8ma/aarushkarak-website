  ...
  return (
    <div className="relative">
      <SEOHead
        path="/about"
        title="About"
        description="Learn more about Aarush Karak — full-stack developer, spatial computing engineer, and founder of The Coder Bros."
      />
      ...
      <div className="relative z-10 page-container">
        <div
          ...
          style={{ width: "600px", height: "600px", top: "5%", right: "-10%" }}
          aria-hidden="true"
        />
        <div
