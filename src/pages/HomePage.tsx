...
const items = [
  {
    ...
    title: "AI Developer",
    icon: Cpu,
    desc: "Building intelligent systems with machine learning, deep learning, and natural language processing.",
  ...
  },
  {
    ...
    icon: Globe,
    desc: "Modern web applications with React, TypeScript, Node.js, and PostgreSQL.",
  ...
  },
  {
    ...
    icon: Box,
    desc: "3D interfaces and gesture-controlled systems using Three.js, MediaPipe, and WebXR.",
  ...
  },
  {
    ...
    icon: DollarSign,
    desc: "Over $5,000 in freelance revenue on Fiverr. Founder of The Coder Bros.",
      ...
      <div className="relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            <div className="lg:w-1/3 shrink-0">
              <ScrollReveal>
                ...
                >
                  Technologies and disciplines I work with daily to build
                ...
                return (
                  <ScrollReveal key={item.id} delay={i * 0.08}>
                    <div className="card-minimal">
                      ...
                      <p className="text-sm text-light/85 leading-relaxed mb-3">
                        {item.desc}
                      </p>
        ...
        <section className="section-container">
          <div className="flex justify-center">
            <Link
              to="/about"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full text-sm font-semibold transition-all border"
              style={{
