...
const markdownComponents: Components = {
  ...
  code: ({ className, children, ...props }) => {
    ...
    if (isInline) {
      return (
        <code className="text-xs px-1.5 py-0.5 rounded" style={{ backgroundColor: 'rgba(var(--color-primary), 0.08)', color: 'rgb(var(--color-primary))' }} {...props}>{children}</code>
      )
    }
    return (
      ...
      <div className="relative z-10 page-container">
        <article className="section-container">
          <ScrollReveal>
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-4 leading-tight" style={{ color: 'var(--text-primary)' }}>
              {post.title}
            </h1>
